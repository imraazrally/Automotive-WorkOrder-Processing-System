...
public class CustomerConsts {
	...
	public static final String REMOVE_CUSTOMER_QUERY="DELETE FROM customer_info WHERE customerId=%s";
	public static final String GET_CUSTOMER_USING_PHONE_QUERY="SELECT * FROM customer_info WHERE phone='%s'";
	public static final String GET_CUSTOMER_USING_NAME_QUERY="SELECT * FROM customer_info WHERE fName='%s' or lName='%s'";	
	public static final String RETRIEVE_CUSTOMER_USING_ID_QUERY="SELECT * FROM customer_info WHERE customerId=%s";	
	public static final String RETRIEVE_ALL_CUSTOMERS="SELECT * FROM customer_info";
